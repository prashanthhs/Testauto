...
public class Modifiedprojectanddelete {
	...
	static void createTasks()
	{
		try
		{
			...
			Thread.sleep(2000);
	    	oBrowser.findElement(By.id("customerLightBox_nameField")).sendKeys("Sachin");
	    	Thread.sleep(6000);
		...
		// create project
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.id("projectPopup_projectNameField")).sendKeys("Tendulkar");
	    	Thread.sleep(6000);
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//*[@id=\"taskListBlock\"]/div[4]/div[1]/div[2]/div[2]/div/div[2]/input")).sendKeys("Crick");
			Thread.sleep(2000);
