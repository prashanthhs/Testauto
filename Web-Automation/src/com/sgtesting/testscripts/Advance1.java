	  ...
	  public static WebDriver obrowser=null;
		...
		static void navigate()
		{
			try
			{
				...
				obrowser.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(50));
			}catch(Exception e)
			{
				e.printStackTrace();
			}
		...
		static void createUser()
		{
			try
			{
				...
				Thread.sleep(2000);
				obrowser.findElement(By.id("userDataLightBox_lastNameField")).sendKeys("ms");
				Thread.sleep(2000);
				obrowser.findElement(By.id("userDataLightBox_emailField")).sendKeys("demo@gmail.com");
				Thread.sleep(2000);
				...
				obrowser.findElement(By.xpath("//*[@id='createUserDiv']/div/div[2]")).click();
				Thread.sleep(2000);
				obrowser.findElement(By.id("userDataLightBox_firstNameField")).sendKeys("rahul");
				Thread.sleep(2000);
				obrowser.findElement(By.id("userDataLightBox_lastNameField")).sendKeys("dravid");
				Thread.sleep(2000);
				obrowser.findElement(By.id("userDataLightBox_emailField")).sendKeys("demo@gmail.com");
				Thread.sleep(2000);
