...
public class AdvancedScenario1 {
	...
	static void createUser1()
	{
		try
		{
			...
			Thread.sleep(2000);
			oPage.clickOnFName().sendKeys("sachin");
			oPage.clickOnLastname().sendKeys("tendulkar");
	...
	static void createUser2()
	{
		try
		{
			...
			oPage.addUsers().click();
			Thread.sleep(2000);
			oPage.clickOnFName().sendKeys("Rahul");
			oPage.clickOnLastname().sendKeys("Dravid");
	...
	static void createUser3()
	{
		try
		{
			...
			oPage.addUsers().click();
			Thread.sleep(2000);
			oPage.clickOnFName().sendKeys("Ms");
			oPage.clickOnLastname().sendKeys("Dhoni");
	...
	static void modifyUser1()
	{
		try
		{
			...
			oPage.clickOnFName().sendKeys("Msd");
