...
public class ActiTimeMainPage {
	public ActiTimeMainPage(WebDriver oBrowser)
	{
	...
	public WebElement clickOnFName()
	{
	...
	public WebElement getConfirmTaskDelete()
	{
		...
		public WebElement getClickOnStart()
		{
			return button;
		}
	...
	//Modify Users:
			...
			public WebElement getWritePwd()
			{
				return password;
			}
			private WebElement passwordCopy;
			public WebElement getWritePwd2()
			{
				return passwordCopy;
			}
